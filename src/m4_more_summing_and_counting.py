...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 3
    answer = count_cosines_from(0, 6, 0.15)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    # Test 3:
    expected = 1
    answer = count_cosines_from(1, 4, 0.29)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    # Test 4:
    expected = 3
    answer = count_cosines_from(5, 10, 0.19)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
    # Test 5:
    expected = 0
    answer = count_cosines_from(7, 13, 1.79)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
    # Test 6:
    expected = 0
    answer = count_cosines_from(2, 5, 1.00)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 1.328968  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 9)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
    # Test 3:
    expected = 0.936544  # This is APPROXIMATELY the correct answer.
